...
public class NumeroComplejoMain {
	...
	public static void main(String[] args) {
		...
		do {
			...
			System.out.println("1. Sumar dos número complejos");
			System.out.println("2. Multiplicar dos número complejos");
			System.out.println("3. Comparar dos número complejos (iguales o no)");
			System.out.println("4. Multiplicar un numero complejor por uno entero");
			...
			case 1: System.out.println("\nDigite el primer numero complejo: ");
					...
					System.out.println("\nLa sumas es: "+suma.getA()+" + "+suma.getB()+"i");
					break;
			...
			case 3: System.out.println("\nDigite el primer numero complejo: ");
					...
					if(numero1.comprobarIgualdad(numero2)) {
						...
						System.out.println("\nLos numeros complejor NO son iguales");
					}
					break;
